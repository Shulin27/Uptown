...
require'db.php';
$cityname=$_GET['place'];
$prop1="SELECT * FROM details WHERE City='$cityname'";
          ...
          <div class="col-md-4">
            <div class="property-wrap ftco-animate">
              ...
              <div class="text">
                ...
                <h3><a href="properties-single.php?id=1"><?php echo $result1['Name']; ?></a></h3>
                <span class="location"><?php echo $result1['Location']; ?></span>
                <a href="properties-single.php?id=1" class="d-flex align-items-center justify-content-center btn-custom">
